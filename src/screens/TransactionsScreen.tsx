  ...
  return (
    <div className="min-h-screen">
      ...
      <button
        ...
        className="fixed bottom-24 right-4 w-14 h-14 bg-[#0d6e5a] text-white rounded-full shadow-lg hover:bg-[#0a5747] active:scale-95 transition-all flex items-center justify-center z-30"
