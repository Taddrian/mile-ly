          ...
          <div>
            ...
            <div className="flex justify-between items-end">
              <div>
                ...
                <p className="text-white font-bold text-lg">SGD {fmt(card.currentSpent)}</p>
              </div>
              <div className="text-right">
                <p className="text-white/60 text-xs mb-0.5">Remaining</p>
                <p className="text-white font-semibold text-base">SGD {fmt(Math.max(remaining, 0))}</p>
              </div>
            </div>
          </div>
        </div>
    ...
    <div className="min-h-screen">
      <div className="px-5 pt-14 pb-4 md:pt-6">
        ...
        <p className="text-sm text-zinc-400 dark:text-zinc-500 mt-0.5">
          SGD {fmt(totalSpent)} spent of SGD {fmt(totalLimit)} total limit
        </p>
      </div>
